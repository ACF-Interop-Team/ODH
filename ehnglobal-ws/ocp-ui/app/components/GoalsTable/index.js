...
function  GoalsTable({ elements, onRowClick, goalsWithTasks, manageGoalsUrl }) {
  ...
  function createTableRows(goal, isPatientRole) {
    ...
    return (
      ...
      >
        ...
        >
          {goal.description && goal.description.text && goal.description.text}
        </TableRowColumn>
        <TableRowColumn
          onClick={() => {
            onRowClick(goal.logicalId);
        ...
        >
          {goal.lifecycleStatus && goal.lifecycleStatus}
        </TableRowColumn>
        <TableRowColumn
          onClick={() => {
            onRowClick(goal.logicalId);
