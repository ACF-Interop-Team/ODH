...
export const actionTypes = {
  ...
  GET_TASK_RELATED_COMMUNICATIONS:
    actionTypesPrefix + 'GET_TASK_RELATED_COMMUNICATIONS',
  GET_TASK_RELATED_COMMUNICATIONS_SUCCESS:
    actionTypesPrefix + 'GET_TASK_RELATED_COMMUNICATIONS_SUCCESS',
  GET_TASK_RELATED_COMMUNICATIONS_ERROR:
    actionTypesPrefix + 'GET_TASK_RELATED_COMMUNICATIONS_ERROR',
  GET_INITIAL_INTERVIEW_TOKEN:
    actionTypesPrefix + 'GET_INITIAL_INTERVIEW_TOKEN',
  GET_INITIAL_INTERVIEW_TOKEN_SUCCESS:
    actionTypesPrefix + 'GET_INITIAL_INTERVIEW_TOKEN_SUCCESS',
};
...
function getInitialInterviewToken(surveyId, firstName, lastName, email, task) {
  return {
    type: actionTypes.GET_INITIAL_INTERVIEW_TOKEN,
    surveyId,
    firstName,
    lastName,
    email,
...
function getInitialInterviewTokenSuccess(token) {
  return {
    type: actionTypes.GET_INITIAL_INTERVIEW_TOKEN_SUCCESS,
    token,
  };
}
...
export const actions = {
  ...
  getInitialInterviewTokenSuccess,
};
