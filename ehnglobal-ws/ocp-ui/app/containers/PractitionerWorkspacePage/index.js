...
import renderDashboardtableuComponent from 'containers/Dashboardtableu/render';
...
export class PractitionerWorkspacePage extends React.Component {
  ...
  static componentMetadata = [
    ...
    {
      name: 'dashboardtableu',
      text: 'Dashboardtableu',
      factoryMethod: renderDashboardtableuComponent,
    },
  ];
            ...
            content: [
              {
                ...
                content: [
                  ...
                  {
                    title: 'Tableu Dashboard',
                    type: 'component',
                    componentName: 'dashboardtableu',
                    isClosable: true,
                    reorderEnabled: true,
                  },
                ],
