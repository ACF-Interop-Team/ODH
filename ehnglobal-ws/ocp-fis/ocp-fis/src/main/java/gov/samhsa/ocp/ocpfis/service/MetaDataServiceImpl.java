...
public class MetaDataServiceImpl implements MetaDataService{
    ...
    public String getMetadata() {
        ...
        authorize.addProperty("valueUri","https://dev-odh.myodh.org/smart/authorize");

        JsonObject token = new JsonObject();
        token.addProperty("url","token");
        token.addProperty("valueUri","https://dev-odh.myodh.org/smart/token");

        JsonObject register = new JsonObject();
        register.addProperty("url","register");
        register.addProperty("valueUri","https://dev-odh.myodh.org/smart/register");
